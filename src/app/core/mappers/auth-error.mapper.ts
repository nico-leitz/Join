...
const AUTH_ERROR_MESSAGES: Readonly<Record<string, string>> = {
  ...
  email_provider_disabled: 'Registration is currently unavailable.',
  captcha_failed: 'The security check failed. Please try again.',
  request_timeout: 'The authentication service did not respond.',
  unexpected_failure: 'The authentication service is currently unavailable.',
