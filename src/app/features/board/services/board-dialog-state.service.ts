...
export class BoardDialogStateService {
   ...
   */
  open(task: Task, subtasks: Subtask[], contacts: Contact[]): void {
    this.setDialogData(task, subtasks, contacts);

    this.setSelection(task, subtasks, contacts);
   ...
   */
  update(task: Task, subtasks: Subtask[], contacts: Contact[]): void {
    this.setDialogData(task, subtasks, contacts);
  }
   ...
   */
  private setDialogData(task: Task | null, subtasks: Subtask[], contacts: Contact[]): void {
    this.task.set(task);
   ...
   */
  private setSelection(task: Task, subtasks: Subtask[], contacts: Contact[]): void {
